...
export const gameFilters: FilterOption[] = [
  ...
  { name: "Blackjack", filter: hasTag("blackjack"), hint: "The venue holds a table for players who wish to gamble gil in a game of 21." },
  ...
  { name: "Texas holdem", filter: hasTag("texas holdem"), hint: "The venue holds a table for players who wish to gamble gil in a game of Texas holdem." },
  { name: "Bingo", filter: hasTag("bingo"), hint: "The venue holds a venue wide bingo game, usually with prizes involved." },
  { name: "Roulette", filter: hasTag("roulette"), hint: "The venue holds a table for players who wish to gamble gil in a game of Roulette." },
];
