...
export function VenueCarousel({ title, venues}: VenueCarouselProps) {
    ...
    return (
        <Collapsible open={open} onOpenChange={setOpen}>
                <CollapsibleTrigger className="ml-9 group flex w-full items-center gap-2 transition-colors duration-200 hover:text-[rgb(227,120,255)] hover:drop-shadow-[0_0_6px_rgba(227,120,255,0.6)]">
                ...
                <CollapsibleContent>
                    <Carousel opts={{ align: "start", loop: false, dragFree: true }} className="w-full mt-3 pb-3">
